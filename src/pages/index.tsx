...
import Featured from "@/component/fragments/Featured";
import { getRealProjects } from "@/services/projects";
import { Project } from "@prisma/client";
import Footer from "@/component/fragments/Footer";
import { FaArrowUp } from "react-icons/fa";
import TechStack from "@/component/ui/TechStack";
const GradientText = dynamic(() => import("@/component/animations/text/gradient"), { ssr: false })
const SplitText = dynamic(() => import("@/component/animations/text/split"), { ssr: false })
const Magnet = dynamic(() => import("@/component/animations/magnet"), { ssr: false })
...
export default function Home({ projects }: { projects: Project[] }) {
    ...
    useEffect(() => {
        const interval = setInterval(() => {
            setShake(true);
            setTimeout(() => setShake(false), 600); // Bergetar sebentar (0.6 detik)
        }, 5000); // Setiap 5 detik sekali
    ...
    return (
        <>
            <Head>
                ...
                <meta name="description" content="Profile Abya, Software Developer" />
                ...
                <meta property="og:description" content="Profile Abya, Software Developer" />
                <meta property="og:image" content="/public/profile1.png" />
                <meta property="og:url" content="" />
                <meta name="viewport" content="width=device-width, initial-scale=1.0" />
                <link rel="icon" href="/a.png" type="img/png" />
            </Head>
            <main className={`w-screen h-screen text-gray-700 bg-black overflow-x-hidden ${inter.className}`} style={{ scrollBehavior: "smooth" }}>
                ...
                <div className="flex flex-col-reverse sm:p-10 lg:pr-32 lg:pl-0 sm:flex-col-reverse lg:flex-row pt-0" id="home">
                    <div className="flex flex-col gap-2  px-6 sm:px-12 md:px-16 lg:px-20">
                        ...
                        <div className="mt-7 flex gap-5 sm:flex-row flex-col">
                            <Magnet>
                                <Link className="bg-green-500 font-semibold text-white lg:text-xl sm:text-lg px-11 py-3 rounded-md hover:scale-90 hover:transition-transform"
                    ...
                    <div className="flex flex-col relative items-center justify-center lg:min-w-96">
                        <div className="shape" />
                        <Image priority src="/profile1.png" width={300} height={400} alt="Profile" className="relative object-cover object-center z-10 lg:w-full sm:w-72 sm:h-72 lg:h-96 rounded-full border-4 border-slate-500 shadow-2xl shadow-amber-400" />
                ...
                <div className="w-full flex flex-col items-center" id="skill">
                    <div className="mt-10 md:px-44 sm:px-20 px-4 flex flex-col gap-8">
                        <div className="md:my-10 sm:my-4 my-0 mx-auto text-center text-wrap max-w-[60vw]">
                            <h2 className="text-white md:text-5xl sm:text-3xl text-2xl font-semibold">Tech Stack</h2>
                            <p className="mx-5 text-[#808080] lg:text-lg md:text-base sm:text-xs text-center">
                        ...
                        <motion.button
                            className="text-slate-200 text-2xl px-2 py-1 bg-[#0a0a0a] border-4 border-[#404040] rounded-3xl cursor-pointer mx-auto"
                        ...
                        {/* 
                        <div className="md:w-44 md:h-44 sm:w-40 sm:h-40 w-32 h-32 p-3 bg-[#0a0a0a] border-4 border-[#404040] flex justify-center items-center rounded-3xl cursor-pointer hover:shadow-xl hover:shadow-yellow-400">
                                    <div className="bg-[#a5d6f7] w-fit h-fit p-2 rounded-3xl hover:transform hover:scale-125 duration-300">
                                        <Image blurDataURL={blurDataURL} placeholder="blur" loading="lazy" alt="" width={100} height={100} src={tools.cloudinary} className="hover:transform hover:scale-105 duration-300" />
                                    </div>
                                </div> */}
                ...
                <div className="xl:px-44 lg:px-44 md:px-20 sm:px-10 px-5 py-0" id="about">
                    ...
                    <div className="md:grid md:grid-cols-3 sm:flex sm:flex-col gap-4">
                        <div className="col-span-1 text-white p-8 relative">
                            <Image blurDataURL={"/blur.webp"} placeholder="blur" alt="profile" src="/profile2.JPG" className=" w-full max-h-96 object-cover rounded-3xl" width={600} height={900} />
